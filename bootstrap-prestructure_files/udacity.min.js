...
function(b){a.serverError=b.error;a.saveDisabled=!1}):a.saveDisabled=!1}}}]);angular.module("account").controller("developmentEnvironmentInfoTab",["$scope","currentUser","developmentEnvironments","$log",function(a,d){a.accountKey=d.get("key")}]);angular.module("account").controller("linkedAccountsTab",["$scope","$timeout","currentUser","users","google","facebook","normalizedSocialService","session","siteExperience",function(a,d,b,c,e,f,g,h,i){a.loading=!0;a.managed=i.managedAccount;a.accounts={google:null,facebook:null};var l=function(){a.serverSuccess="";a.serverError=""},j=function(b,c,e){c=g.normalizeAccount(b,c);c.id===a.user["_"+b+"_id"]||e?c.loggedIn=!0:c={loggedIn:!1};return a.accounts[b]=c},k=function(b){a.loading=!1;a.serverError=
b.error};a.getLinkedAccountTypes=function(){return _.keys(a.accounts)};a.disconnect=function(b){a.loading=!0;var e={key:a.user.key};e[b+"_id"]=null;c.put(e).then(function(c){l();a.loading=!1;a.user=c;"github"!==b&&(a.accounts[b]=null)},k)};a.disconnectSocial=function(b){a.loading=!0;var e={key:a.user.key},d=a.user.social_accounts.length&&"github"==b?"social_accounts":"external_accounts",f=null;_.each(a.user[d],function(a,c){if(a.account_type===b||a.affiliate_program_key===b)f=c});null==f?a.loading=
!1:(a.user[d].splice(f,1),e[d]=a.user[d],c.put(e).then(function(c){l();a.loading=!1;a.user=c;a[b]=null},k))};a.connect=function(b){a.loading=!0;var e=g.normalizeAccountService(b),f=function(g,h){var i=function(a){401===a.code&&f(g-1,3*h)};0===g&&(i=k);d(function(){e.getAccount().then(function(e){var d={key:a.user.key};d[b+"_id"]=e.id;c.put(d).then(function(c){e=j(b,e,!0);l();a.loading=!1;a.user=c},k)},i)},h)},i=function(){f(3,500)};e.login().then(function(a){a=g.createSessionData(b,a);h.put(a).then(i,
i)},k)};l();b.fetchFullUser().then(function(){a.loading=!1;a.user=b.getUser();_.each(a.user.social_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.user.external_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.getLinkedAccountTypes(),function(a){g.normalizeAccountService(a).getAccount().then(function(b){j(a,b)})})},k)}]);angular.module("account").controller("myCertificatesTab",["$q","$scope","$sce","currentUser","users","nodes",function(a,d,b,c,e,f){d.loading=!0;d.verifiedCertificates=[];d.nodeMap={};d.serverError="";var g=c.getUser();d.getBadges=function(){return _.filter(g._badges,function(a){return"Course Mastery"===a.name&&0<a.highest_level})};a.all([e.getCertificates("me").then(function(a){d.verifiedCertificates=a;a=_.map(a,function(a){return a.node_ref.key});return f.batchGet(a,{projection:"catalog"}).then(function(a){_.extend(d.nodeMap,
...
(_.each(_.filter(_.values(c),b),function(b){a.stash(b.key,f,i,b)}),c):{}});var l={},j=[];_.each(c,function(b){var c=a.getFilledEntity(b,f,i);c?l[b]=c:j.push(b)});return d.when(l).then(function(b){return 0<j.length?g(j,h).then(function(c){c&&_.each(_.filter(_.values(c),function(a){return a}),function(c){a.stash(c.key,f,i,c);b[c.key]=c});return b}):b})},standardMixin:function(a,b){var d=_.omit(b,"get","batchGet");d.__gateway=b;d.get=function(d,g){return g&&g.__skipCache?b.get(d,g):c.get(d,a,b.get,g,
...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","gaqHelper","cookieJar","googleTagManager",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(a){return{nd000:{start:"May 6 at noon Eastern Time",end:"May 12 at 11:59 pm Eastern Time"},nd001:{start:"May 6 at noon Eastern Time",
end:"May 12 at 11:59 pm Eastern Time"},nd002:{start:"May 6 at noon Eastern Time",end:"May 12 at 11:59 pm Eastern Time"},nd003:{start:"May 6 at noon Eastern Time",end:"May 12 at 11:59 pm Eastern Time"},nd004:{start:"May 6 at noon Eastern Time",end:"May 12 at 11:59 pm Eastern Time"}}[a]||{}},c=function(){i.pushTrackingEvent("nanodegreeAccess");a._goToClass()};a.getNanodegreeButtonInfo=function(){if(a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated))return{variant:"nanodegree is live, student is enrolled or graduated",
text:"Continue nanodegree",action:c};if(a.isPaidEnrollable){if(a.isClassFull)return a.isPaidWaitlisted?(h.exists("udacity_notify_me_clicked_recently")&&(i.pushTrackingEvent("notificationListJoin"),g.pushTrackingEvent("Waitlist","SignUp",a.courseKey),h.remove("udacity_notify_me_clicked_recently")),{variant:"nanodegree is full, student is waitlisted",statusMessage:"You will be emailed when enrollment opens "+b(a.courseKey).start,statusSuccess:!0}):{variant:"nanodegree is full, student not waitlisted, not enrolled",
text:"Notify me",sidenote:"when nanodegree re-opens",statusMessage:"<strong>Next enrollment opens "+b(a.courseKey).start+".</strong><br>You can start the program immediately after you enroll.",action:function(){h.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});a._joinGroup(a.waitlistGroupKey)}};var d="",d="nd002"===a.courseKey?"You can start the program immediately after you enroll.":"You can start the program immediately after you enroll. <br><strong>Enrollment closes "+
b(a.courseKey).end+".</strong>";return{variant:"nanodegree live, student not enrolled",text:"Enroll in Nanodegree",sidenote:"One week trial",statusMessage:d,action:function(){i.pushTrackingEvent("nanodegreeEnrollment");a._purchaseCourse()}}}return{variant:"nanodegree not open for paid enrollment",sidenote:"This nanodegree is not yet available for enrollment"}};a=_.extend(a,a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);a.hasProductLaunched=a.enrollmentActions.isLaunched;
a.isVIP=a.isAccessible&&(!a.isAvailable&&!a.isLaunched||a.canEditContent)&&a.getNanodegreeButtonInfo().action!==c;a.isFull=a.isClassFull&&!(a.isPaidInterested||a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("overview").controller("nanodegreePortal",["$scope","cacheVersion","nodes","$window","currentUser","dateTime","api","$timeout","$q","productState","modal","fetchDiscourseLink",function(a,d,b,c,e,f,g,h,i,l,j,k){var m={};a.submissions={};a.submissionsFetched={};a.launchHangoutOnAir=function(a,b){j.activate(a).finally(function(){var a=$("#"+b),c=a.attr("src");a.attr("src","");a.attr("src",c)})};a.dismiss=function(){j.confirm()};var p=function(b){var b=b||0,c=_.find(a.submissionsFetched,
...
{groupKeys:["6256644858314752","bd-nd001-201504"],fields:{timelineUrl:"https://docs.google.com/document/d/1cq3Qngz67K3nlAp7VbIWgyzC0DuM2PXSyb5DcHmkR1c/pub?embedded=true"}}],fields:{officeHours:{url:"https://plus.google.com/communities/117736402989322525566/events",label:"Mondays at 9PM Eastern Time"},studentHandbookUrl:{label:"Front-End Student Handbook",url:"https://docs.google.com/document/d/1NOHs9j1OmzM8iK_D3OR-seSMRSSasnS1SzvXTFfP05k/pub?embedded=true"}}},{nanodegreeKey:"nd002",cohorts:[{groupKeys:["5140722388303872"],
fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/1DktL9l2gt7wJ0fOljXKgm6nrkIoApM2SKaArqkM8Fq0/pub?embedded=true"}},{groupKeys:["6708040971059200","bd-nd002-201412"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/17IdPL6soArRqCTVdjWGOpswREaGYx6foLNyV18HBBxs/pub?embedded=true"}},{groupKeys:["5323305082421248","bd-nd002-201501"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/10fSQ3zYKSof-gVR4iPFn8NrGNEccDRytfVh31_8TEh4/pub?embedded=true"}},
{groupKeys:["6319104843055104","bd-nd002-201502"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/18_nAkFmABL7UThIGSHuiv1JvSxaq0D6F-xOIp7OxNYk/pub?embedded=true"}},{groupKeys:["5764048242606080","bd-nd002-201503"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/1MvCysqTnWONbQDvzT0SnWsPRwzOTXTztedj5jENsz4E/pub?embedded=true"}},{groupKeys:["6535685729419264","bd-nd002-201504"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/13PmA2163W_kz_XF9fu_paC4EgHgKrWsqORR6ROfBGlE/pub?embedded=true"}}],
fields:{officeHours:{url:"https://plus.google.com/u/0/communities/116797052510270749486/events",label:"Tuesdays at 1PM Eastern Time, Thursdays at 9PM Eastern Time"},studentHandbookUrl:{label:"Data Analyst Student Handbook",url:"https://docs.google.com/a/knowlabs.com/document/d/1ZHwe0R5z61HXGcssgQvnuXHdm7D5U9Y8xx_Ra18GWAs/pub?embedded=true"}}},{nanodegreeKey:"nd003",cohorts:[{groupKeys:["6435323516551168","bd-nd003-201503"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/1mSO6hbMpdqfDIawd06VSXP5iIvvfvJ8Y212o2EIh3-c/pub?embedded=true"}},
{groupKeys:["5943260287860736","bd-nd003-201504"],fields:{timelineUrl:"https://docs.google.com/a/knowlabs.com/document/d/1HMh0mF9uCzZ9I108EsuYLcSKe6xsON8YKeiA98Y1_ns/pub?embedded=true"}}],fields:{officeHours:{url:"https://docs.google.com/a/knowlabs.com/document/d/1Bz3KsMD2H4oyyClaqW4S4UG5HPtXZPWU7NckmaXXtXI/pub?embedded=true",label:"Office Hours Schedule"},studentHandbook:{label:"iOS Nanodegree Student Handbook",url:"https://docs.google.com/document/d/1R59drlFwUdEwOWWO34T9SqK77iy1SnHFYtCoO0FNCmk/pub?embedded=true"}}},
{nanodegreeKey:"nd004",cohorts:[{groupKeys:["6152833176436736","bd-nd004-201502"],fields:{timelineUrl:""}},{groupKeys:["5302193229398016","bd-nd004-201503"],fields:{timelineUrl:"https://docs.google.com/document/d/1yQYM-D8ORX6K6i74uG3JTTWFRCrQtO5ohF9DMdraiv4/pub?embedded=true"}},{groupKeys:["4923294474305536","bd-nd004-201504"],fields:{timelineUrl:"https://docs.google.com/document/d/1JZF5xyCw2l8LiZ9flrDPTVwSUQJ7xgX7M2S3Oy_yev4/pub?embedded=true"}}],fields:{officeHours:{url:"https://www.google.com/calendar/embed?src=2g7k2utipoipf36n6efstihne4%40group.calendar.google.com&ctz=America/Los_Angeles",
label:"Sign Up Here"},studentHandbookUrl:{label:"Full Stack Student Handbook",url:"https://docs.google.com/document/d/1aqruU5LZ6_1xugQdISC5fwsStjV21SAppuR2SZn_q3E/pub?embedded=true"}}}]);angular.module("overview").controller("overviewPage",["$scope","$location","modal","youtubeVideoPlayer","facebook","productState","gaqHelper","showChat",function(a,d,b,c,e,f,g,h){a.productState=f;a.toggleInstructors={};a.showTrailer=function(){var a=window.location.pathname.split("/").pop();g.pushTrackingEvent("CourseOverview","TrailerPlayed",a);a=function(){c.pauseVideo()};b.activate("trailer").then(a,a);c.playVideo()};a.showGroupChat=!1;h.getGroupChatPromise().then(function(b){a.showGroupChat=b});
...
(a.fieldErrors=e.errorText,a.buttonDisabled=!1)};a.signInFacebook=function(){return l.getAuthResponse().then(function(a){return c.put({facebook:{signed_request:a.signedRequest}}).then(p,r)},n)};a.signInGoogle=function(){i.getToken(!1).then(function(a){return c.put({google:{token:a.code}}).then(p,r)},n)}}]);angular.module("account").controller("signUpForm",["$scope","$q","$sce","$timeout","session","users","currentUser","groups","validator","google","facebook","$location","safelyRedirect","gaqHelper","googleTagManager","retry","cookieJar",function(a,d,b,c,e,f,g,h,i,l,j,k,m,p,n,r,q){a._removeEmailCookie=function(){q.exists("emailAddressForSignUp")&&q.remove("emailAddressForSignUp",{path:"/"})};var s=function(){var b=function(){var b=a.initialSearch.next;b?m(b):m("/")},c=a.initialSearch.enroll,e=a.initialSearch.enroll_state||
"enrolled",f=a.initialSearch["join-group"],e=c?g.enroll(c,e,!0):d.when(!0),i=f?g.fetchFullUser().then(function(){return h.addMember(f,g.get("key"))}):d.when(!0),l,j;a._removeEmailCookie();l=c?p.pushTrackingEvent("SignUp","Enroll",c):p.pushTrackingEvent("SignUp","Direct");j=n.pushTrackingEvent("RegistrationCompleted");return e["finally"](function(){return i["finally"](function(){return l["finally"](function(){return j["finally"](b)})})})},v=function(c){a.errorMessage=b.trustAsHtml("We were unable to validate your account.");
return d.reject(c)},w=function(c){a.errorMessage=b.trustAsHtml("We were unable to access your account.");return d.reject(c)},t=function(c){409===c.data.status?(a.errorMessage=b.trustAsHtml("This account already exists, please sign in to continue."),a._removeEmailCookie()):a.errorMessage=b.trustAsHtml("Something went wrong and we're currently looking into it.");a.buttonDisabled=!1;return d.reject(c)};a.signUpEmail=function(){a.buttonDisabled=!0;a.errorMessage=null;a.fieldErrors=null;var b=i.check({email:{pretty:"your email address",
value:a.email,validators:[{type:"required",chained:[{type:"email"}]}]},password:{pretty:"your password",value:a.password,validators:[{type:"required",chained:[{type:"strLen",args:[7,void 0]}]}]},firstName:{pretty:"your first name",value:a.firstName,validators:[{type:"required"}]},lastName:{pretty:"your last name",value:a.lastName,validators:[{type:"required"}]}});b.valid?f.registerUser({email_address:a.email,first_name:a.firstName,last_name:a.lastName,password:a.password,tos_accepted:!0}).then(s,
t):(a.fieldErrors=b.errorText,a.buttonDisabled=!1)};a.signUpFacebook=function(){return j.getAuthResponse().then(function(a){return j.getMeResponse().then(function(b){return f.registerUser({email_address:b.email,first_name:b.first_name,last_name:b.last_name,facebook:{signed_request:a.signedRequest},tos_accepted:!0}).then(s,t)},w)},v)};a.signUpGoogle=function(){l.getToken(!1).then(function(a){return e.put({google:{token:a.code}}).then(s,function(){return r(l.getMeResponse,5,100).then(function(a){return l.getToken(!0).then(function(b){return f.registerUser({email_address:a.email,
first_name:a.given_name,last_name:a.family_name,google:{token:b.code},tos_accepted:!0}).then(s,t)},v)},w)})},v)};q.exists("emailAddressForSignUp")&&(a.email=q.get("emailAddressForSignUp"))}]);angular.module("account").controller("viewerSettings",["$scope","currentUser","users","techDetect","$window",function(a,d,b,c){a.isBrowserIE="Explorer"===c.browserStats().browser;a.videoQualities=[{label:"Automatic",value:"default"},{label:"360p",value:"medium"},{label:"480p",value:"large"},{label:"720p",value:"hd720"},{label:"1080p",value:"hd1080"}];a.playbackRates=[{label:"0.25x",value:0.25},{label:"0.5x",value:0.5},{label:"Normal",value:1},{label:"1.5x",value:1.5},{label:"2x",value:2}];var e=d.getUser();
...
a.save=function(){a.serverSuccess=a.serverError="";a.saving=!0;e.site_preferences={use_html5_player:a.settings.useHtml5Player,auto_advance:a.settings.autoAdvance,playback_rate:a.settings.playbackRate.value,video_quality:a.settings.videoQuality.value};b.put(e).then(function(){a.saving=!1;a.serverSuccess="Classroom Settings Saved"},function(b){a.saving=!1;a.serverError=b.error})}}]);angular.module("payment").controller("checkoutPage",["$scope","paymentFlow","$routeParams","$location","api","gaqHelper","currentUser","cacheVersion","modal","dateTime","optimizely","$timeout",function(a,d,b,c,e,f,g,h,i,l,j,k){g.get("_registered")||(window.location.href="/account/auth#!/signup?next="+encodeURIComponent(window.location.href));a.$on("$routeChangeSuccess",function(){f.pushPageviewEvent();if(angular.isDefined(b.stepNumber)&&d.isInFlow())d.goToStep(b.stepNumber);else{var e=[];c.search().products?
(e=c.search().products.split(","),d.begin(e),a.flow=d.getCurrentFlowData()):window.history.back()}});a.getCurrentDate=function(){return l.getCurrent()};a.isProductLaunched=function(a){return a&&a.launch_date&&new Date(a.launch_date)<l.getCurrent()};a.isProductNotLaunched=function(a){return a&&!a.was_launched};a.getDatePlusDays=function(a,b){return a?new Date(a.getTime()+864E5*b):null};a.step={};a.submitStep=function(b){a.step.submitting=!0;d.submitStep(b).then(function(){a.step.submitting=!1;$("html,body").animate({scrollTop:0})})};
a.getCacheBustingUrl=function(a){return a&&a+"?"+h};a.currentUserName=g.getFullName();a.currentUserEmail=g.get("email").address;a.currentUserNickname=g.get("nickname");a.getCurrentUserIsVerified=function(){return g.get("email")._verified};a.getCurrentStep=d.getCurrentStep;a.getCurrentFlowSteps=d.getCurrentFlowSteps;k(function(){!a.getCurrentUserIsVerified()&&!window.optimizelyDisableVerificationModal&&i.activate("verify email")},1);a.$on("$includeContentLoaded",function(){j.activate()})}]);angular.module("page.payment",["core"]).config(["$routeProvider",function(a){a.when("/:stepNumber",{}).otherwise({redirectTo:"/0"})}]);angular.module("payment").constant("DAY_IN_MILLISECONDS",864E5).factory("fullClassExperienceFlowDefinition",["$q","stripeCreditCard","validator","api","currentUser","products","customers","couponCode","users","$timeout","$log","nodes","DAY_IN_MILLISECONDS","optimizely","userTrials","googleTagManager",function(a,d,b,c,e,f,g,h,i,l,j,k,m,p,n,r){var q=function(a){return"card_declined"===a.code?"Your card was declined. Please try again. If this issue persists, please contact payment-support@udacity.com.":
"processing_error"===a.code?"An error occurred while processing your card. Please try again.If this issue persists, please contact payment-support@udacity.com.":a.code?a.message:"An error occurred while processing your card. Please check your information and try again. If this issue persists, please contact payment-support@udacity.com."},s=function(a){return a&&_.map(a._course_groups,function(a){return a.course_ref&&a.course_ref.key})},v=function(b,d){var e={product_keys:d.productKeys};b&&b.id&&(e.stripe_token=
b.id);d.coupon&&d.coupon.valid&&(e.coupon_id=d.coupon.key);return c.post("/customers/me/purchases",e).then(function(a){return a.data.purchase},function(b){d.generalPaymentFormError=b.data.error?q(b.data):"We are having difficulties processing your request. If this error keeps appearing please contact payment-support@udacity.com.";b.data.was_charged&&alert("Error - your card was charged successfully but an error occured.Please contact us at payment-support@udacity.com immediately and we'll get this sorted out. Your spot is reserved. Please do NOT pay again.");
return a.reject(b)})};return[{label:"Checkout",view:"/templates/angular/payment/payment_form.html",onStart:function(b,e){var i=[f.get(e.productKeys[0]),g.get("me")];if(h){var l=c.get("/coupons/"+h+"/compute_discount",{product_key:e.productKeys[0]}),l=l.then(function(a){e.coupon=a.data.coupon;a.data.coupon.valid&&(e.coupon.discounted_price=a.data.result)},function(){e.coupon={valid:!1};return null});i.push(l)}a.all(i).then(function(a){e.product=a[0];var b=_.first(e.product._course_groups).course_ref.key;
k.get(b).then(function(a){var b=a.catalog_entry._image?a.catalog_entry._image.serving_url:null;e.confirmationStepLabel={Degree:"Start Nanodegree",Course:"Start course"}[a._semantic_type];e.course={key:a.key,imageUrl:b,isNanodegree:"Degree"===a._semantic_type};r.pushTrackingEvent("checkoutStart",{productName:e.product.name,productPrice:e.product.amount,orderNodeKey:e.course.key,isNanodegree:"Degree"===a._semantic_type})});b=e.product.trial_period_days;e.inTrialPeriod=0<b;e.trialPeriodStarts=new Date(Date.now()+
b*m);e.customer=a[1];e.customerCard=d.getDefaultCard(e.customer);e.cardIsLoaded=!0;e.uriEncodedCourseKey=window.encodeURIComponent(s(e.product));p.activate()})},onJump:function(a){return a.paymentConfirmed?!1:!a.paymentConfirmed},onSubmit:function(b,c){if(c.customerCard)return v(!1,c);var e=b.creditCard||{},f=d.checkValidity(e);c.creditCardErrors=f.errorText;if(!f.valid)return!1;f=(c.product&&c.product.name)+", "+s(c.product);return d.createPaymentToken(f,e).then(function(a){return v(a,c)},function(b){c.generalPaymentFormError=
q(b.error);return a.reject(b)})}},{getLabel:function(a){return a.confirmationStepLabel},view:"/templates/angular/payment/payment_confirmation.html",onStart:function(a,b){b.paymentConfirmed=!0;b.payment=a;var c=b.product&&(b.product.amount||0)/100,d=null;try{d=_.find(a.customer.subscriptions,function(a){return a.plan.id===b.product.key}).id}catch(e){j.error("Failed to get Transaction Id",e)}_gaq.push(["_addTrans",d,"Udacity",c,"0.00","0.00","Mountain View","California","USA"]);_gaq.push(["_addItem",
d,"DD44",b.product&&b.product.name,s(b.product),c,"1"]);_gaq.push(["_trackTrans"]);r.pushTrackingEvent("CompletedOrder",{transactionVal:c,transactionOrderId:d,transactionPromoCode:h,orderNodeKey:b.course.key,isNanodegree:b.course.isNanodegree})}}]}]);angular.module("payment").factory("paymentFlow",["$q","paymentState","$location",function(a,d,b){return{begin:function(a){a=d.startFlow(a);if(a.onStart)a.onStart(null,d.getCurrentFlowData());b.path("/"+d.getCurrentStep().number.toString())},submitStep:function(c){var e=a.defer();(c=d.getCurrentStep().onSubmit(c,d.getCurrentFlowData()))?a.when(c).then(function(a){var c=d.goToNextStep();if(c.onStart)c.onStart(a,d.getCurrentFlowData());e.resolve();b.path("/"+c.number.toString())},function(){e.resolve()}):
e.resolve();return e.promise},goToStep:function(a){a=window.parseInt(a,10);if(a!==d.getCurrentStep().number&&(a=d.getStepNumber(a),!a.onJump||a.onJump(d.getCurrentFlowData()))){if(a.onStart)a.onStart(null,d.getCurrentFlowData());b.path("/"+d.goToNextStep().number.toString())}},isInFlow:d.isInFlow,getCurrentStep:d.getCurrentStep,getCurrentFlowSteps:d.getCurrentFlowSteps,getCurrentFlowData:d.getCurrentFlowData}}]);angular.module("payment").factory("paymentFlowDefinitions",["fullClassExperienceFlowDefinition",function(a){var d={"default":a};_.each(d,function(a){_.each(a,function(a,b){a.number=b})});return{get:function(){return d["default"]}}}]);angular.module("payment").controller("paymentForm",["$scope","api",function(a,d){a.sendVerificationEmail=function(){d.post("/users/send_verification_email").success(function(){a.resentVerificationEmail=!0}).error(function(a){console.error("Something went wrong",a)})};a.refresh=function(){window.location.reload()}}]);angular.module("payment").factory("paymentState",["paymentFlowDefinitions",function(a){var d=null,b=null,c={};return{startFlow:function(e){d=a.get(e);b=d[0];c={productKeys:e||[]};return b},getCurrentStep:function(){return b},getStepNumber:function(a){return d[a]},isInFlow:function(){return!!d},getCurrentFlowSteps:function(){return d},getCurrentFlowData:function(){return c},setCurrentStepNumber:function(a){return b=d[a]},goToNextStep:function(){return b=d[b.number+1]}}}]);angular.module("payment").factory("stripeCreditCard",["$http","$q","$rootScope","validator",function(a,d,b,c){var e=window.Stripe,f=!!e,g={createPaymentToken:function(a,c){var l=d.defer(),j=g.checkValidity(c);j.valid?f&&e.createToken({subject:a,name:c.nameOnCard,number:c.number,cvc:c.cvc,exp_month:c.expiryMonth,exp_year:c.expiryYear},function(a,c){b.$apply(function(){c.error?l.reject(c):l.resolve(c)})}):l.reject(j);return l.promise},checkValidity:function(a){return c.check({nameOnCard:{pretty:"cardholder's name",
...
g.pending[e]&&g.pending[e].readyNotification(g.run);if(null!==b)g.pending=_.without(g.pending,b),b["finally"](g.run),g.running.push(b),d(b.start);else break}}};return g};c=a.make;return a}]);angular.module("user").factory("currentUser",["$log","$q","$rootScope","users","basicUser","gaqHelper","nodes","nodeUtility","userUtility","cohortsGateway",function(a,d,b,c,e,f,g,h,i,l){var j=angular.copy(e),k={get:function(a){return j[a]},getUser:function(){return j},getFullName:function(){return i.getFullName(j)},isStaff:function(){if(j._memberships)return 0<_.filter(j._memberships,function(a){return-1<a.group_ref.key.indexOf("staff")}).length},getEnrolledCourses:function(){k.get("_enrollments");
return _.chain(k.get("_enrollments")).filter(function(a){if(a&&"enrolled"===a.state)return!0}).map(function(a){return a.node_key}).value()},getEnrolledNanodegreeKeys:function(){return _.filter(k.getEnrolledCourses(),function(a){return 0===a.indexOf("nd")})},fetchGraduatedNanodegreeKeys:function(){return k.fetchCertificates().then(function(a){return _.chain(a).map(function(a){return a.node_ref.key}).filter(function(a){return 0===a.indexOf("nd")}).value()})},fetchEnrolledAndGraduatedNanodegreeKeys:function(){return k.fetchGraduatedNanodegreeKeys().then(function(a){return _.union(k.getEnrolledNanodegreeKeys(),
a)})},getGroupKeys:function(){k.get("_memberships");return _.chain(k.get("_memberships")).filter(function(a){return a.group_ref&&"Group"===a.group_ref.ref}).map(function(a){return a.group_ref.key}).value()},getEmail:function(){return i.getEmail(j)},setUser:function(a){angular.copy(angular.copy(a),j)},fetchFullUser:function(a){a=a?{cacheBust:Math.random()}:{};return c.get("me",a).then(function(a){k.setUser(a);return a})},fetchCertificates:function(){return j._certificates?d.when(j._certificates):c.getCertificates("me").then(function(a){return j._certificates=
a})},checkIfFirstChatVisit:function(){return c.checkIfFirstChatVisit("me")},setFirstChatVisit:function(){return c.setFirstChatVisit("me")},fetchCohorts:function(){return k.fetchFullUser().then(function(a){return d.all(_.map(a._cohort_keys,function(a){return l.get(a)}))},function(b){a.error(b)})},userIsLoggedIn:function(){return j._registered},isEnrolledIn:function(a){return _.some(j._enrollments,function(b){return b.node_key===a&&"enrolled"===b.state})},isEnrolledForCreditIn:function(a){var b=["151101088",
...
i=null,l=0,j=f.length;l<j;l++){i=f[l].match(/([^=]+)=/i);if(angular.isArray(i))try{g=decodeURIComponent(i[1]),h=!1===c?f[l].substring(i[1].length+1):decodeURIComponent(f[l].substring(i[1].length+1))}catch(k){}else g=decodeURIComponent(f[l]),h="";d[g]=h}return d};return{exists:function(a){if(!angular.isString(a)||""===a)throw new TypeError("$cookieJar.exists(): Cookie name must be a non-empty string.");return d(document.cookie,!0).hasOwnProperty(a)},get:function(a,c){var c=angular.isObject(c)?c:{},
...
identity:"Linux"}],i=function(a){if(null===b.browser||a)b.browser=e(g)||"An unknown browser";return b.browser},l=function(a){if(null===b.version||a)i(),b.version=f(navigator.userAgent)||f(navigator.appVersion)||"an unknown version";return b.version},j=function(a){if(null===b.os||a)b.os=e(h)||"an unknown OS";return b.os},k=function(a){if(null===b.cookies||a)document.cookie="cookietest=1",b.cookies=-1!==document.cookie.indexOf("cookietest="),document.cookie="cookietest=1; expires=Thu, 01-Jan-1970 00:00:01 GMT";
...
screen.colorDepth;return b.screenColorDepth};return a.eventEmission({browserSize:p,browserType:i,browserVersion:l,cookiesEnabled:k,flashEnabled:m,os:j,screenSize:n,screenColorDepth:r,ua:function(){return b.ua},language:function(){return b.lang},flushCache:c,browserStats:function(a){return{browser:i(a),version:l(a),os:j(a)}},getAllTech:function(a){a=!!a;i(a);l(a);j(a);k(a);m(a);p(a);n(a);r(a);return b}},["browserDetected"])}]);angular.module("utility").factory("userTrials",["mixin","currentUser","recordActivity","userTrialsHelper",function(a,d,b,c){var e={enroll:function(a,g){if("string"!==typeof a||"string"!==typeof g||""===a.trim()||""===g.trim())console.error("Trial key and treatment must both be non-empty strings.");else{var h=c.getEnrollments(d.get("key"));h[a]=g;c.saveEnrollments(d.get("key"),h);b.experimentAssignment(a,g);e.emitEvent("enrollment",{trial:a,treatment:g})}},unenroll:function(a){if("string"!==typeof a||
...
if(null!==f){var g=+f[1],h=+f[3],f=new Date(h,g-1,+f[2]);return(""+f.getFullYear()).slice(-2)===(h+"").slice(-2)&&f.getMonth()===g-1?a:d}return d}};return{check:function(a){var c,e={valid:!0,errorText:{}},f,g;for(g in a)if(a.hasOwnProperty(g)){c=a[g];for(var h=0;h<c.validators.length;h++)if(f=c.validators[h],"undefined"===typeof f.disabled||!1===f.disabled)if("function"===typeof d[f.type]){var i=c.value,l=c.pretty||g,j=d[f.type](i,l,f.args||[]);j.valid?f.hasOwnProperty("chained")&&(j={},j[g]={pretty:l,
value:i,validators:f.chained},f=this.check(j),!1===f.valid&&(e.valid=!1,e.errorText[g]=e.errorText[g]||[],e.errorText[g]=e.errorText[g].concat(f.errorText[g]))):(e.valid=!1,e.errorText[g]=e.errorText[g]||[],e.errorText[g].push("undefined"===typeof f.failMsg?j.errorText.charAt(0).toUpperCase()+j.errorText.slice(1):f.failMsg))}else console.warn("You tried to use a validator that doesn't exist! The name you tried to use was: "+f.type)}return e}}}]);angular.module("viewer").controller("contentGate",["$scope","modal","currentUser","$location",function(a,d,b,c){a.signUpAndReturnToCourse=function(a){window.location.href="/account/auth#!/signup?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(c.path())+"&enroll="+encodeURIComponent(a)};a.signInAndReturnToCourse=function(a){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(c.path())+"&enroll="+encodeURIComponent(a)};a.enrollInCourse=function(c){a.enrollRequestPending=
...
c,e,f,g,h,i,l,j,k,m,p,n,r,q,s,v,w,t,x,E,F,I,J,G,H,D){function A(){var b;b=_.without(_.union(j.general,j[u]),null,void 0,"");a.viewerLoadingMessage=b[_.random(b.length-1)];a.isViewerLoading=!0}function z(a,b,c){if(a){var d=n[a.model];if(d){if(!c||d.extension)return"/templates/angular/viewer/partials/"+d.prefix+b+"?"+l}else console.error("Unrecognized morsel type "+a.model)}else if(!c)return"/templates/angular/viewer/partials/loading"+b+"?"+l}function B(a){f.cancel(y);("Video"===a.model||"SketchVideo"===
a.model)&&h.addEventListener("videoPlay",function(){f.cancel(y);y=f(C(a.key),1E3*g,!1)},{removeAfterFired:!0})}function C(a){return function(){if(h.getCurrentTime()>=g){var b=h.getCurrentTime();h.emitEvent("videoPause",b);h.emitEvent("videoPlay",b+1);d.markMorselAsCompleted(a)}else y=f(C(a),500,!1)}}a.modalsUrl="/templates/viewer/partials/viewer_modals.html?"+l;a.getCoachServicesUrl=function(){if(a.course)return"/conditional/tutoring?course_id="+window.encodeURIComponent(a.course.key)+"&cache_bust="+
l};a.userIsLoggedIn=t.userIsLoggedIn();a.canEditNotes=F;a.course=null;a.lessons=null;a.lesson=null;a.morsels=null;a.morsel=null;a.tidbit=null;var u=b.path().match("/"+m.course+"([^/]+)"),u=u?u[1]:null;a.courseKeyFromUrl=u;u||(window.location.href="/");s.addEventListener("sessionExpired",function(){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path())});v&&(window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path()));
d.addEventListener("lessonPermissionDenied",function(){window.location.href="/course/"+u});d.addEventListener("courseChange",function(a){if((!a.lessons||0===a.lessons.length)&&!a.lastLessonVisited&&!c.lessonKey)window.location.href="/course/"+u}).addEventListener("coursePermissionDenied",function(){c.lessonKey||(window.location.href="/course/"+u)});d.addEventListener("lessonChange",function(a){if(!a.morsels||0===a.morsels.length)window.location.href="/course/"+u});a.isViewerLoading=!0;d.addEventListener("courseChange",
...
b=b.indexInLesson;b<c-1?a.goToMorsel(a.morsels[b+1]):(h.pauseVideo(),a.course?t.userIsLoggedIn()&&t.isEnrolledIn(a.course.key)?a.lessons&&a.lesson.key===a.lessons[a.lessons.length-1].key?(a.enrollment=_.find(t.get("_enrollments"),function(b){return b.node_key===a.course.key}),w.activate("endOfCourse",{courseIsComplete:a.course.catalog_entry.complete,courseKey:a.course.key,isPaidEnrolled:x.isCurrentEnrolled(a.enrollment,a.course),isGraduated:x.isGraduated(a.enrollment,a.course)})):w.activate("endOfLesson",
{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):t.userIsLoggedIn()?w.activate("endOfLessonEnrollGate",{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):w.activate("endOfLessonSignInGate",{lessonKey:a.lesson.key,userIsLoggedIn:t.userIsLoggedIn()}):w.activate("endOfIsolatedContent"))};a.goToPreviousMorsel=function(){var b=a.morsel;b.containingExercise&&(b=b.containingExercise);b=b.indexInLesson;0<b?a.goToMorsel(a.morsels[b-1]):console.error("Can't go to previous; at beginning of lesson")};
...
b.showFeedbackDialog=function(){b.morselTitle=b.morsel.title;"Video"===b.morsel.model?(g.pauseVideo(),b.feedbackOptions=l):b.feedbackOptions="ImageFormQuiz"===b.morsel.model||"ProgrammingQuiz"===b.morsel.model?j:k;c.activate("feedback")};var m=function(a){for(var a=_.pairs(a),b={},c=0;c<a.length;++c){var d=a[c][0],e=a[c][1];if(_.isObject(e))for(var e=_.pairs(m(e)),f=0;f<e.length;++f)b[d+"."+e[f][0]]=e[f][1];else void 0!==e&&null!==e&&(b[d]=e)}return b};b.submitFeedback=function(){b.formValidationResults=
a.check(b.form);if(b.formValidationResults.valid){var j=[{context:e.getCurrent(),data:{model:"SurveyResponse",survey_name:"LessonFeedbackVersion2"}}],l={reason:b.form.feedbackReason.value,explanation:b.form.feedbackExplanation.value,techDetect:f.getAllTech(),currentUrl:window.location.href};"Video"===b.morsel.model&&(l=_.extend(l,{youtube:{availablePlaybackRates:g.getAvailablePlaybackRates(),currentPlaybackRate:g.getCurrentPlaybackRate(),currentTime:g.getCurrentTime()}}));l=m(l);j[0].data.items=_.map(_.pairs(l),
function(a){return{name:a[0],content:a[1]}});d.send(j);c.confirm();b.form.feedbackReason.value=null;b.form.feedbackExplanation.value=null;c.activate("feedback-confirmation").then(function(){"Video"===b.morsel.model&&g.playVideo()})}}}]}}]);angular.module("viewer").factory("codeEditor",["mixin","codeMirror","libraryLoader",function(a,d,b){function c(a){return-1!==a.indexOf(".c")?"c":-1!==a.indexOf(".cpp")?"cpp":-1!==a.indexOf(".css")?"css":-1!==a.indexOf(".cu")?"cuda":-1!==a.indexOf(".e")?"specman":-1!==a.indexOf(".glsl")?"glsl":-1!==a.indexOf(".html")?"html":-1!==a.indexOf(".java")?"java":-1!==a.indexOf(".js")?"javascript":-1!==a.indexOf(".json")?"javascript":-1!==a.indexOf(".m")?"octave":-1!==a.indexOf(".py")?"python":-1!==a.indexOf(".r")?
...
{morselId:h.key,comment:"We encountered an error. Please try submitting again."})})}else f(function(){_.reduce(h.widgets,function(a,b){return a&&k.answers[b.marker]===b.correct_value},!0)?k.emitEvent("correct",{morselId:h.key}):k.emitEvent("incorrect",{morselId:h.key})},10)}};return a.eventEmission(k,"ready submitting incorrect correct recorded error evaluation".split(" "))}]);angular.module("viewer").factory("isTrustedDomain",[function(){return function(a){return"https://www.udacity.com"===a||"http://localhost:8080"===a||"http://localhost:8087"===a||"https://assignments-dot-udacity-extras.appspot.com"===a}}]);angular.module("viewer").factory("lesson",["api","$q","mixin","lessonContentContext","typeForTag","freshContent",function(a,d,b,c,e,f){function g(a,b){var c=_.find(a,function(a){for(var c=b.length-1;0<=c;c--){var d=a.content_context[c];if(!d||d.node_ref.key!==b[c].node_key||d.tag!==b[c].tag)return!1}return!0});c&&(c=_.object(_.map(c.content_context,function(a){return[e[a.tag]+"Key",a.node_ref.key]})));return c}var h=null,i=null,l=null,j=null,k=null,m=null,p=null,n={announcePendingCourseChange:function(){n.emitEvent("pendingCourseChange",
{course:h})},changeCourse:function(b){var e=Math.round((new Date).getTime());p=e;d.all([a.get("/nodes/"+b+"?depth=1&fresh="+(!0===f)+"&required_behavior=view&projection=navigation"),a.get("/nodes/"+b+"/state?fresh=true")]).then(function(a){var d=a[0].data,f=a[1].data,k=a=null;if(e===p){h=d.references.Node[b];i=d.references.Node;h.steps_refs=_.reject(h.steps_refs,function(a){return!i[a.key]});if(d=_.find(f.nodestates,function(a){return a.node_ref.key===b}))(k=g(d.last_interactions,c.getCurrent()))&&
k.lessonKey&&(a=i[k.lessonKey]);n.emitEvent("courseChange",{course:h,lessons:_.map(h.steps_refs,function(a,b){var c=i[a.key];c.indexInCourse=b;return c}),lastLessonVisited:a})}},function(a){e===p&&a.status&&(403===a.status||404===a.status)&&n.emitEvent("coursePermissionDenied",b)})},announcePendingLessonChange:function(){n.emitEvent("pendingLessonChange",{lesson:l})},changeLesson:function(b){var e=Math.round((new Date).getTime());m=e;d.all([a.get("/nodes/"+b+"?depth=2&fresh="+(!0===f)+"&required_behavior=view&projection=classroom"),
a.get("/nodes/"+b+"/state?fresh=true")]).then(function(a){if(e===m){var d=a[0].data,f=a[1].data,a=null;l=d.references.Node[b];j=d.references.Node;l.steps_refs=_.reject(l.steps_refs,function(a){return!j[a.key]});_.each(l.steps_refs,function(a,b){var c=j[a.key];if(!c)throw Error("Expected a morsel but got "+JSON.stringify(c,2));"Exercise"===c.model&&(_.each(["lecture_ref","quiz_ref","answer_ref"],function(a){c[a]&&(c[a]=j[c[a].key],c[a]&&(c[a].containingExercise=c))}),_.each(c.tidbits,function(a){a.tidbit_ref=
j[a.tidbit_ref.key];a.tidbit_ref&&(a.tidbit_ref.containingExercise=c)}));j[a.key].indexInLesson=b});_.each(j,function(a){if("ImageFormQuiz"===a.model||"ProgrammingQuiz"===a.model)a.binCodes=[]});if(d=_.find(f.nodestates,function(a){return a.node_ref.key===b}))_.each(d.completed_descendant_node_refs,function(a){n.markMorselAsCompleted(a.key)}),(d=g(d.last_interactions,c.getCurrent()))&&d.morselKey&&(a=j[d.morselKey]);n.emitEvent("lessonChange",{lesson:l,morsels:_.map(l.steps_refs,function(a){return j[a.key]}),
lastMorselVisited:a})}},function(a){e===m&&a&&(a.status&&(403===a.status||404===a.status))&&n.emitEvent("lessonPermissionDenied",b)})},announcePendingMorselChange:function(a){n.emitEvent("pendingMorselChange",{from:k,to:a})},changeMorsel:function(a){k=j[a];n.emitEvent("morselChange",k)},changeTidbit:function(a){n.emitEvent("tidbitChange",{tidbit:a?j[a]:null})},markMorselAsCompleted:function(a){j[a]?j[a].completed=!0:console.error("Can't find morsel #"+a+" to mark it as completed")},updateProgressForMorsel:function(a,
b){j[a]&&j[b]?j[a].progressNodeId=b:console.error("Can't find container morsel #"+a+" or perhaps progress morsel #"+b+" to update progress")},updateLastSubmissionForMorsel:function(a,b){j[a]?j[a].lastSubmission=b:console.error("Can't find morsel #"+a+"to update activity")},mergeBinCodesForMorsel:function(a,b){j[a]&&(j[a].binCodes=_.union(j[a].binCodes,b))}};return b.eventEmission(n,"pendingCourseChange courseChange pendingLessonChange lessonChange pendingMorselChange morselChange tidbitChange lessonPermissionDenied coursePermissionDenied".split(" "))}]);angular.module("viewer").factory("lessonPrefetcher",["$http","$timeout","lesson",function(a,d,b){var c=null;b.addEventListener("courseChange",function(a){c=a.lessons},{replayLast:!0});b.addEventListener("courseChange",function(){b.addEventListener("lessonChange",function(b){var f=_.find(c,function(a){return a.key===b.lesson.key}).indexInCourse;if(0<f){var g=c[f-1].key;d(function(){a.get("/api/nodes/"+g+"?depth=2&fresh=false&required_behavior=view&projection=classroom")},1E4,!1)}if(0<=f&&f<c.length-
...
var j=null,k=null,m=function(b,c){var c=c||{},d={items:_.map(b,function(a){return{occurrence_time:c.timestamp||e.getCurrentAsUTC(),content_context:_.without(a.context,null,void 0,"none"),data:a.data}}),current_time:e.getCurrentAsUTC()},f="/api/activity";c.chain&&(f+="?related_chain=true");return a.post(f,d).then(function(a){200!==a.status&&(console.error("Error when trying to post activity. Response:"),console.error(a))})};c.addEventListener("videoPlay",function(a){j=a},{replayLast:!0});c.addEventListener("videoPause",
function(a){null!==j&&(null!==a&&void 0!==a)&&(k=a,m([{context:b.getCurrent(),data:{model:"PlayableView",start:j,stop:k}}]));j=k=null},{replayLast:!0});f.addEventListener("evaluation",l,{replayLast:!0});g.addEventListener("evaluation",l,{replayLast:!0});d.addEventListener("morselChange",function(a){if(!a.completed&&("Reading"===a.model||"EmbeddedFrame"===a.model))d.markMorselAsCompleted(a.key),m([{context:b.getCurrent(),data:{model:"CompletedExperience",completion_context:"Student viewed the node"}}])});
...
{projection:"image"}).then(function(b){b&&b._image_url&&a.partners[d].push({imageUrl:b._image_url,name:b.name})})})};a.fetchCards=function(b,c){return d.batchGet(b).then(function(d){return _.without(_.map(b,function(b){var e=!1,l=d[b];if(d[b]){var j=null,k=l.catalog_entry;k&&k._image&&(j=k._image.serving_url);c&&(l.affiliate_program_refs&&0<l.affiliate_program_refs.length)&&"udacity"!==l.affiliate_program_refs[0].key&&(e=!0,a._fetchAffiliate(l.affiliate_program_refs,b));return{key:b,servingUrl:j,
title:l.title,isNanodegree:"Degree"===l._semantic_type,showPartner:e&&c}}return null}),null)})};a._setLengthOfRow=function(a,b){return!b||6<b?6>=a?a:0===a%6?6:0===a%5?5:0===a%4?4:0===a%3?3:6:b};a.setUpCards=function(b,d,g,h,i){b?(a.lengthOfRow=a._setLengthOfRow(b.length,d),a.columnWidthClass="col-xs-"+a._calculateColumnWidth(a.lengthOfRow),a.cardImageSize=[1200/a.lengthOfRow,0],angular.isArray(h)&&2===h.length?a.cardImageSize=h:angular.isNumber(h)&&(a.cardImageSize=[h,0]),i?1===i?a.columnWidthClass=
...
e);d.task=a.uploadQueue.getUniqueTask(d.uploadPath);d.task&&(d.task.notify(function(a){d.loaded=a.loaded;d.total=a.total}),b.find("input").remove(),d.task["finally"](c))}}}]);angular.module("widgets").directive("upsellBanner",["currentUser","cookieJar","nodeUtility","cacheVersion","$location","$window","safelyRedirect",function(a,d,b,c,e,f,g){return{restrict:"A",templateUrl:function(a,b){if("banner"!==b.bannerStyle){if("check"===b.bannerStyle)return"/templates/viewer/upsell_check.html?"+c;if("pad"===b.bannerStyle)return"/templates/viewer/upsell_pad.html?"+c}return"/templates/viewer/upsell_banner.html?"+c},link:function(c,i,l){c.$watch("course",function(g){if(g){var i=
_.find(a.get("_enrollments"),function(a){return a.node_key===g.key}),i=i&&b.isCurrentEnrolled(i,g),m;m="pad"===l.bannerStyle?d.exists("upsell-cancel-banner-progress"):d.exists("upsell-cancel-banner-viewer");c.showBanner=!m&&c.course.catalog_entry.paid_class&&c.course.catalog_entry.paid_class.open_for_enrollment&&!i;c.learnMore="/success#!/?courseKey="+f.encodeURIComponent(g.key)+"&start="+f.encodeURIComponent(e.absUrl())}else c.showBanner=!1});c.goToPurchase=function(a){f.location.href="/checkout#!/0?products="+
f.encodeURIComponent(_.first(a.catalog_entry.paid_class.class_product_refs).key)};c.cancelBanner=function(){d.set("upsell-cancel-banner-"+("pad"===l.bannerStyle?"progress":"viewer"),!0);c.showBanner=!1};c.goEnroll=function(){c.course&&g("/course/"+encodeURIComponent(c.course.key))}}}}]).directive("upsellHeader",["currentUser","cookieJar","nodeUtility","$location","cacheVersion","nodes","products","$window",function(a,d,b,c,e,f,g,h){return{restrict:"A",templateUrl:"/templates/upsell_header.html?"+
